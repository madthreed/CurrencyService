...
@FeignClient(name = "FeignOpenExchangeRatesAPIClient", url = "${openexchangerates.url}")
public interface FeignOpenExchangeRatesAPIClient extends ExchangeRatesClient {
